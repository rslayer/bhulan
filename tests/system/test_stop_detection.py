...
from tests.system.fake_db import FakeMongoClient  # noqa: E402
from tests.system.test_helpers import (  # noqa: E402
    assert_stop_near,
    generate_gps_route,
    generate_single_stop_route,
    setup_stubs,
)
...
from classes import TruckPoint  # noqa: E402
from init import CONSTRAINT, MIN_STOP_TIME  # noqa: E402
from processVehicles import findStops, findStopsAll, getGPSFrequency  # noqa: E402
...
class TestStopDetection(unittest.TestCase):
    ...
    def test_find_stops_all_multiple_trucks(self):
