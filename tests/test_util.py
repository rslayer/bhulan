...
class TestDistanceFunctions(unittest.TestCase):
    ...
    def test_kil_dist_zero_distance(self):
    ...
    def test_kil_dist_one_degree_latitude(self):
    ...
    def test_kil_dist_symmetry(self):
    ...
    def test_mile_dist_one_degree_latitude(self):
    ...
    def test_meter_dist_relation_to_kil_dist(self):
    ...
    def test_find_arc_zero_for_same_point(self):
    ...
    def test_find_arc_positive_for_different_points(self):
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_kil_dist_antipodal_points(self):
    ...
    def test_kil_dist_across_dateline(self):
    ...
    def test_find_arc_handles_floating_point_precision(self):
