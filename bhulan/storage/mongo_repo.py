...
class MongoTrackPointRepository(TrackPointRepository):
    ...
    def __init__(self, mongo_uri: Optional[str] = None, db_name: Optional[str] = None):
        ...
        self.client: MongoClient = MongoClient(  # type: ignore[type-arg]
            self.mongo_uri,
    ...
    def create_indexes(self) -> None:
        ...
        self.collection.create_index([("device_id", ASCENDING), ("ts_utc", ASCENDING)])
    ...
    def get_by_device_and_time(
        ...
        """
        query = {"device_id": device_id, "ts_utc": {"$gte": start_time, "$lte": end_time}}
...
class MongoJobRegistry(JobRegistry):
    ...
    def create_job(self, ingest_id: str, source: str, params: Dict[str, Any]) -> None:
        """
        ...
        job_doc = {
            ...
            "finished_at": None,
            "stats": {"read": 0, "accepted": 0, "rejected": 0},
            "error_sample": {},
        }
